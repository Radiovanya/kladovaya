...
Нет публичного бронирования, клиентского кабинета, CRM-воронки, календаря, онлайн-кассы, 1С, SMS automation, электронной подписи, multi-tenant архитектуры, сложного BI, импорта/экспорта и audit log. Сформированный договор отправляется как HTML и Markdown; PDF сотрудник сохраняет через системную печать.
